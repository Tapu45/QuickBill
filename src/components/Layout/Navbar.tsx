 ...
 return (
  ...
  >
    <div className="flex h-full items-center justify-between px-4 sm:px-6">
      {/* Left side - Page Title & Sidebar Toggle */}
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <h1 className="text-base sm:text-xl font-semibold">{pageName}</h1>
      </div>

      {/* Store/Counter Dropdowns - hide on mobile */}
        ...
        <div className="hidden md:flex relative">
          <div className="flex items-center bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-full px-4 py-2 shadow-sm transition focus-within:ring-2 focus-within:ring-primary">
            ...
            <input
              ...
              className="bg-transparent border-none outline-none pl-2 w-40 lg:w-56 text-sm text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500"
            />
          </div>
        </div>

        {/* Mobile search icon */}
        <button className="md:hidden rounded-full p-2 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-sm hover:bg-gray-100 dark:hover:bg-gray-800 transition">
